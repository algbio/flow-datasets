...
# Parameters
GENOMES=(5 10 15 20 25 30 35 40)
WINDOWS=(5000)
K=63
DATASET="ecoli"
EXTRA_OPTS="--distribution lognormal11 --mincycles 1 --nreads 5 --readlength 1000"
# Error variants: "none" means perfect weights; "imp" enables Poisson edge errors
E_VARIANTS=(none imp)
MAX_JOBS="${MAX_JOBS:-4}"  # override concurrently via: MAX_JOBS=8 ./scripts/run_ecoli.sh
